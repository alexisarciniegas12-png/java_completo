...
@Controller
@RequestMapping("/cliente/reservaciones")
public class ReservacionesClienteController {
    ...
    public ReservacionesClienteController(ReservacionRepository repo,
    ...
    public String list(Model model) {
        ...
        return "reservaciones_cliente/list";
    }
    ...
    public String form(Model model) {
        ...
        return "reservaciones_cliente/form";
    }
    ...
    public void generarPdf(HttpServletResponse response) throws IOException {
        ...
        response.setHeader(
                "Content-Disposition",
                "attachment; filename=reporte_reservaciones_cliente.pdf"
        );
